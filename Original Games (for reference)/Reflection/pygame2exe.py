...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "Reflection.pyw"
 
        #Name of program
        self.project_name = "Reflection"
        ...
        self.extra_datas = ['Images', 'Levels', 'Modules']
    ...
    def run(self):
        ...
        setup(
            ...
            options = {'py2exe': {'optimize': 2, 'bundle_files': 1, 'compressed': False, \
